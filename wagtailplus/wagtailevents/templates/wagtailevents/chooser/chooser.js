function(modal) {
    function ajaxifyLinks (context) {
        $('a.event-choice', context).click(function() {
    ...
    var searchUrl = $('form.event-search', modal.body).attr('action')
    ...
    $('form.event-create', modal.body).submit(submitForm);
    $('form.event-search', modal.body).submit(search);
    ...
    function detectErrors() {
        ...
        $('form.event-create .error-message').each(function(){
