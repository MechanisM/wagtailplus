function(modal) {
    function ajaxifyLinks (context) {
        $('a.contact-choice', context).click(function() {
    ...
    var searchUrl = $('form.contact-search', modal.body).attr('action')
    ...
    $('form.contact-create', modal.body).submit(submitForm);
    $('form.contact-search', modal.body).submit(search);
    ...
    function detectErrors() {
        ...
        $('form.contact-create .error-message').each(function(){
